    ...
    <Stack.Navigator screenOptions={screenOptions}>
      <Stack.Screen
        ...
        options={({ navigation, route }) => ({
          ...
          headerLeft: () => (
            <Icon name={getFocusedRouteNameFromRoute(route) === "Register" ? "user-plus" : "sign-in"} type="font-awesome" iconStyle={styles.stackIcon} onPress={() => navigation.toggleDrawer()} />
          ),
        })}
      />
    </Stack.Navigator>
...
const Main = () => {
  ...
  const showNetInfo = async () => {
    ...
    Platform.OS === "ios" ? Alert.alert("Initiona Network Connmectivity Type", connectionInfo.type) : ToastAndroid.show("Initial Network Connectivity Type: " + connectionInfo.type, ToastAndroid.LONG);
  };
